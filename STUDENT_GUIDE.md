...
### STEP 2. Orca에서 Codex 창 다시 열기

최신 코드 반영이 끝났다면 Orca에서 아래 순서대로 진행하세요.

![Orca에서 Codex 창을 닫고 다시 여는 방법](docs/orca-codex-restart-guide.png)

1. Orca 상단에서 **현재 Codex 탭 오른쪽의 `×`**를 눌러 Codex 창을 닫습니다.
2. 같은 상단 탭 줄의 **`+` 버튼**을 누릅니다.
3. 열린 메뉴에서 **Codex**를 누릅니다.
4. 터미널에 **OpenAI Codex** 화면이 열리면 성공입니다.

주의:

- Orca 앱 전체를 종료하는 것이 아닙니다.
- 프로젝트 폴더를 삭제하지 않습니다.
- clone을 다시 받지 않습니다.
- Orca 작업트리를 삭제하지 않습니다.
- **현재 Codex 탭만 닫고 같은 자리에서 새 Codex 창을 여는 것**입니다.
